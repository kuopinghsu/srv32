...
<img src="https://github.com/kuopinghsu/simple-riscv/blob/master/images/dhrystone.vcg" alt="Dhrystone" width=640>
...
|-----------| ---------- | ----------- | ----------- | ------------ | ----------------------- |
| Dhrystone | 1.938 DMIPS/MHz<br>1.205CPI | 2.2 DMIPS/MHz<br>1.194CPI | 3.734 DMIPS/MHz<br>1.070CPI | 3.734 DMIPS/MHz<br>1.070CPI | 3.783 DMIPS/MHz<br>1.157CPI | 3.996 DMIPS/MHz<br>1.000CPI |
| Coremark  | 0.91 Coremark/MHz<br>1.367CPI | 2.74 Coremark/MHz<br>1.259CPI | 0.97 Coremark/MHz<br>1.4PI | 2.702 Coremark/MHz<br>1.253CPI | 3.072 Coremark/MHz<br>1.099CPI | 3.372 Coremark/MHz<br>1.000CPI |
...
Two instructions brach panelty if branch taken, CPI is 1 for other instructions. The average Cycles per Instruction (CPI) is approximately 1.1 on Dhrystone diag.
