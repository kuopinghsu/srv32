...
#define CONSTANTS_H_
     ...
     const  double RESOLUTION_DEFAULT = 0.01;  /* secs (normally 2.0) */
     const  int RANDOM_SEED = 101010;

    /* default: small (cache-contained) problem sizes */

     const  int FFT_SIZE = 128;  /* must be a power of two */
     const  int SOR_SIZE =10; /* NxN grid */
     const  int SPARSE_SIZE_M = 100;
     const  int SPARSE_SIZE_nz = 500;
     const  int LU_SIZE = 10;
