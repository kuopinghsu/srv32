...
class rv32rtl(pluginTemplate):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.dut_exe = os.path.join(config['PATH'] if 'PATH' in config else "","sim")
    ...
    def build(self, isa_yaml, platform_yaml):
      ...
      # for rv32rtl start building the '--isa' argument. the self.isa is dutnmae specific and may not be
      # useful for all DUTs
    ...
    def runTests(self, testList):
      ...
      for testname in testList:
          ...
          if self.target_run:
            ...
            simcmd = self.dut_exe + ' +trace {0}; mv dump.txt DUT-rv32rtl.signature'.format(elf)
          else:
            simcmd = 'echo "NO RUN"'
